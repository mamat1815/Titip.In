...
android {
    ...
    defaultConfig {
        ...
        // --- PERBAIKAN DI SINI ---
        // Kita ambil value mentah, lalu kita bungkus dengan escaped quotes \"...\" secara programatis
        // Ini mencegah error "String too large" dan "semicolon expected"
        val firebaseBaseUrl = localProperties.getProperty("FIREBASE_FUNCTIONS_BASE_URL") ?: ""
        buildConfigField("String", "FIREBASE_API_KEY", "\"$firebaseBaseUrl\"")

        val merchantUrl = localProperties.getProperty("MERCHANT_URL") ?: ""
        buildConfigField("String", "MERCHANT_URL", "\"$merchantUrl\"")

        val merchantClientKey = localProperties.getProperty("MERCHANT_CLIENT_KEY") ?: ""
        buildConfigField("String", "MERCHANT_CLIENT_KEY", "\"$merchantClientKey\"")
